			...
			<div class="panel-body">
				<form class="create" id="contactForm">
					...
					<div class="savebtn editmessbtn">
						<a href="javascript:void(0)" class="btn btn-success" data-id="{{ $message->id }}" id="edit-emp-item" data-toggle="modal" data-target="#myModal2">Send Message With Corrections</a>
					</div>
					<div class="savebtn editmessbtn">
